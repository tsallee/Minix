...
extern struct pi process_info // holds the info gathered by sys_getproctab
extern char* p_info_pointers // holds the address of p_info_pointers, which is used by sys_vircopy
